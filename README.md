...
- ចំណេះដឹងត្រូវបានគ្រប់គ្រងក្នុង `knowledge.json` ដើម្បីឱ្យចម្លើយដូចគ្នាសម្រាប់អ្នកប្រើទាំងអស់
...
AI នេះជា retrieval-based AI ខ្នាតតូច មិនមែន LLM ដូច ChatGPT ទេ។ ចំណេះដឹងត្រូវបានដាក់ក្នុង `knowledge.json` រីឯព័ត៌មានផ្ទាល់ខ្លួន និងប្រវត្តិសន្ទនារក្សាទុកតែក្នុង browser/ឧបករណ៍នោះ។
